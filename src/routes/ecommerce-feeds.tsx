...
export const Route = createFileRoute("/ecommerce-feeds")({
  component: EcommerceFeeds,
});
        ...
        <section className="px-6 max-w-5xl mx-auto pt-20 pb-16 text-center min-h-[400px]">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-slate-600 mb-8 max-w-2xl mx-auto leading-relaxed text-[17px] lato-regular">
              Automatically generate perfectly structured product feeds for Google Shopping, Facebook Catalog, and more. Boost your store's visibility instantly.
            </p>
            
            <div className="max-w-3xl mx-auto bg-white rounded-2xl border border-slate-200 shadow-sm p-12 text-left mt-12">
              <h2 className="text-2xl font-bold text-slate-800 mb-6 bricolage-grotesque-main">Why use our feed generator?</h2>
              
              <div className="space-y-6 lato-regular">
                <div className="flex gap-4">
                  <div className="mt-1"><CheckCircle2 className="w-5 h-5 text-[#00b87c]" /></div>
                  <div>
                    <h3 className="font-bold text-slate-800 text-[16px]">Google Merchant Center Ready</h3>
                    <p className="text-slate-600 mt-1">Our feeds map your products perfectly to Google's strict requirements.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="mt-1"><CheckCircle2 className="w-5 h-5 text-[#00b87c]" /></div>
                  <div>
                    <h3 className="font-bold text-slate-800 text-[16px]">Auto-Syncing</h3>
                    <p className="text-slate-600 mt-1">When prices or inventory changes, your XML feed updates automatically.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="mt-1"><CheckCircle2 className="w-5 h-5 text-[#00b87c]" /></div>
                  <div>
                    <h3 className="font-bold text-slate-800 text-[16px]">Multi-Platform Support</h3>
                    <p className="text-slate-600 mt-1">Compatible with Facebook, Pinterest, Instagram, and TikTok catalogs.</p>
                  </div>
                </div>
              </div>
